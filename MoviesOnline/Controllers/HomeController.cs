...
namespace MoviesOnline.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, IMoviesServices moviesServices, IShoppingCartServices shoppingCartService, IWishlistServices wishlistService, IHttpContextAccessor httpContextAccessor, DataContext dataContext)
        {
            _logger = logger;
