...
namespace MoviesOnline.Controllers
{
    public class MoviesController : Controller
    {
        ...
        [HttpPost]
        public IActionResult UploadTrailer()
        {
            try
            {
                var file = Request.Form.Files[0];
                var folderName = Path.Combine("wwwroot", "Trailers");
                ...
                if (file.Length > 0)
                {
                    ...
                    _logger.LogInformation(LoggerMessageDisplay.TrailerUploaded);
            ...
            {
                _logger.LogError(LoggerMessageDisplay.TrailerUploadedError + " | " + ex);
