...
namespace MoviesOnline.Controllers
{
    public class WishlistController : Controller
    {
        ...
        public WishlistController(IWishlistServices wishlistService, IHttpContextAccessor httpContextAccessor, IMoviesServices moviesServices, IShoppingCartServices shoppingCartService)
        {
